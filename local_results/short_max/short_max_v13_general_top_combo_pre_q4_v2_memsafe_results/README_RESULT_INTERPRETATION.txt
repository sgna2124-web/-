SHORT_MAX v13 general top-combo pre-Q4 v1
...
이번 목적:
2025-Q4 폭발 구간을 제외한 상태에서 pre-Q4 상위 후보 조건들을 조합해 일반 구간의 꾸준함을 높이는 후보를 찾는다. summary_compact는 general_consistency_score 기준으로 정렬된다. 이 점수는 CD, positive_month_ratio, top3_month_share 패널티를 함께 본다.
