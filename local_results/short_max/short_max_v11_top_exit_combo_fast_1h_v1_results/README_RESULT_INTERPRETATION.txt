SHORT_MAX v11 top exit combo fast 1h v1
...
이번 목적:
직전 실행의 상위 후보(stop215, stop212, rr540)의 조건을 조합한다. 진입 조건은 그대로 유지하고 stop/rr/time_reduce/fail_fast/min_expected_tp 주변부만 좁게 조정한다.
