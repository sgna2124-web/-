SHORT_MAX v13 structural dev fast 1h v1
...
이번 목적:
현재 short_max v13을 바탕으로 2025-Q4 폭발 구간 없이도 꾸준히 작동하는 후보를 찾는다. summary_compact는 general_consistency_score 기준으로 정렬된다. 이 점수는 CD, positive_month_ratio, top3_month_share 패널티를 함께 본다.
