# AUTO-GENERATED: 8V4 full-run long_max restore
# target=8V4_V51_V002_core_rare22_c1
# batch=RESTORE_EXACT_8V4_LONG400_FULL_FEE008_V1
# sequential=False
...
RESULT_ROOT = REPO_ROOT / "local_results" / 'RESTORE_EXACT_8V4_LONG400_FULL_FEE008_V1'
RESULT_ROOT.mkdir(parents=True, exist_ok=True)
...
if not _target_matches:
    print("[TARGET_PROBE] first 30:", [getattr(s, "name", None) for s in STRATEGIES[:30]], flush=True)
