...
# target=6V2_L01_doubleflush_core
# batch_label=RESTORE_EXACT_6V2_L01_FEE008_V4
...
RESULT_ROOT = REPO_ROOT / "local_results" / 'RESTORE_EXACT_6V2_L01_FEE008_V4'
RESULT_ROOT.mkdir(parents=True, exist_ok=True)
...
_TARGET_STRATEGY_NAME = '6V2_L01_doubleflush_core'
