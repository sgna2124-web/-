...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v68_short_only_attack_split_execution_hybrid.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v68_short_only_attack_split_execution_hybrid.json'
...
if __name__ == '__main__':
    ...
    for exp in vsplitmod.build_experiments(base, group):
        ...
        s.update({
            ...
            'engine_mode': 'attack_split_execution_hybrid_short',
        })
