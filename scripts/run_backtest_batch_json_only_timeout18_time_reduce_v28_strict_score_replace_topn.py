...
SRC = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v28_strict_score_replace_topn.json'
DST = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v27_strict_score_replace_topn.json'
V28_COMB_DEFAULT = 'experiments/combinations_json_only_timeout18_time_reduce_v28_strict_score_replace_topn.json'
...
if __name__ == '__main__':
    ...
    try:
        ...
        os.environ['V27_COMB'] = os.environ.get('V28_COMB', V28_COMB_DEFAULT)
