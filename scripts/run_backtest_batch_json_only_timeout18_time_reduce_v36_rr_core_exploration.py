...
SRC = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v36_rr_core_exploration.json'
DST = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v27_strict_score_replace_topn.json'
V36_COMB_DEFAULT = 'experiments/combinations_json_only_timeout18_time_reduce_v36_rr_core_exploration.json'
...
if __name__ == '__main__':
    ...
    try:
        ...
        os.environ['V27_COMB'] = os.environ.get('V36_COMB', V36_COMB_DEFAULT)
