...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v66_short_only_balanced_split_bridge_hybrid.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v66_short_only_balanced_split_bridge_hybrid.json'
...
if __name__ == '__main__':
    ...
    for exp in vsplitmod.build_experiments(base, group):
        ...
        s.update({
            ...
            'engine_mode': 'balanced_split_bridge_hybrid_short',
        })
