...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v63b_long_only_split_architectures.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v63b_long_only_split_architectures.json'
