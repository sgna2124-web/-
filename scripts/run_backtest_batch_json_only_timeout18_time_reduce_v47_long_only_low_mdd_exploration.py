...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v47_long_only_low_mdd_exploration.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v47_long_only_low_mdd_exploration.json'
