...
def main() -> None:
    ...
    if not RESULTS_DIR.exists():
        print("results_json_only_short_strict directory does not exist.")
        return
    ...
    for exp_dir in sorted(RESULTS_DIR.iterdir()):
        ...
        rows.append(
            {
                "experiment_group": "json_only_short_strict",
    ...
    if not rows:
        print("No experiment summaries found under results_json_only_short_strict/.")
        return
    ...
    lines = ["master_summary_json_only_short_strict", ""]
