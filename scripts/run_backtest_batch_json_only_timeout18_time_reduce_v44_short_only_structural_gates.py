...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v44_short_only_structural_gates.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v44_short_only_structural_gates.json'
