...
SRC = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v33_non_top200_adventurous.json'
DST = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v27_strict_score_replace_topn.json'
V33_COMB_DEFAULT = 'experiments/combinations_json_only_timeout18_time_reduce_v33_non_top200_adventurous.json'
...
if __name__ == '__main__':
    ...
    try:
        ...
        os.environ['V27_COMB'] = os.environ.get('V33_COMB', V33_COMB_DEFAULT)
