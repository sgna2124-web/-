...
SRC = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v37_rr30_timeout40_exploration.json'
DST = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v27_strict_score_replace_topn.json'
V37_COMB_DEFAULT = 'experiments/combinations_json_only_timeout18_time_reduce_v37_rr30_timeout40_exploration.json'
...
if __name__ == '__main__':
    ...
    try:
        ...
        os.environ['V27_COMB'] = os.environ.get('V37_COMB', V37_COMB_DEFAULT)
