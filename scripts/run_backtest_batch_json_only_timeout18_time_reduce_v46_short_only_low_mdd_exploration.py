...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v46_short_only_low_mdd_exploration.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v46_short_only_low_mdd_exploration.json'
