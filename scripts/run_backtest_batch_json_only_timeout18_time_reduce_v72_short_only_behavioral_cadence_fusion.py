...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v72_short_only_behavioral_cadence_fusion.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v72_short_only_behavioral_cadence_fusion.json'
...
if __name__ == '__main__':
    ...
    for exp in v56mod.v27mod.build_experiments(base, group):
        ...
        s.update({
            ...
            'engine_mode': 'behavioral_cadence_fusion_short',
        })
