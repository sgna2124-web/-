...
COMB=ROOT/'experiments'/'combinations_json_only_timeout18_time_reduce_v5.json'
...
if __name__=='__main__':
 ...
 d=ROOT/'results_json_only_timeout18_time_reduce_v5'; d.mkdir(parents=True,exist_ok=True); pd.DataFrame(out).to_csv(d/'single_changes_quick_summary.csv',index=False)
