...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v67_long_only_hybrid_wick_bridge.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v67_long_only_hybrid_wick_bridge.json'
...
if __name__ == '__main__':
    ...
    for exp in vsplitmod.build_experiments(base, group):
        ...
        s.update({
            ...
            'engine_mode': 'hybrid_wick_bridge_long',
        })
