...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v21_1_strict.json'
COMB_ENV = os.environ.get('V21_1_COMB', 'experiments/combinations_json_only_timeout18_time_reduce_v21_1_strict_cd.json')
...
if __name__=='__main__':
    ...
    d=ROOT/'results_json_only_timeout18_time_reduce_v21_1_strict'; d.mkdir(parents=True, exist_ok=True); pd.DataFrame(out).to_csv(d/'single_changes_quick_summary_cd.csv', index=False)
