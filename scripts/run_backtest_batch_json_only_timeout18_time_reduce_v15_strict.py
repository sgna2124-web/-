...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v15_strict.json'
COMB_ENV = os.environ.get('V15_COMB', 'experiments/combinations_json_only_timeout18_time_reduce_v15_strict_structural.json')
...
def evaluate_portfolio_time_axis(trades, initial_asset, position_fraction):
    ...
    for idx, tr in enumerate(trades):
        entries.append((tr['entry_ts'], 1, idx))
        exits.append((tr['exit_ts'], 0, idx))
...
if __name__ == '__main__':
    ...
    d = ROOT / 'results_json_only_timeout18_time_reduce_v15_strict'
