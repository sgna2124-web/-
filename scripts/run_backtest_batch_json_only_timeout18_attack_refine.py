...
BASE=ROOT/'experiments'/'base_config_json_only_timeout18_attack_refine.json'
COMB=ROOT/'experiments'/'combinations_json_only_timeout18_attack_refine.json'
...
if __name__=='__main__':
 ...
 d=ROOT/'results_json_only_timeout18_attack_refine'; d.mkdir(parents=True,exist_ok=True); pd.DataFrame(out).to_csv(d/'single_changes_quick_summary.csv',index=False)
