...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v57_long_only_hybrid_guards_and_entry_modes.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v57_long_only_hybrid_guards_and_entry_modes.json'
