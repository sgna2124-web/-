...
BASE_CONFIG_PATH = ROOT / "experiments" / "base_config_json_only_short_strict.json"
SINGLE_CHANGES_PATH = ROOT / "experiments" / "single_changes_json_only_short_strict.json"
...
def main() -> None:
    ...
    if all_rows:
        out_path = ROOT / "results_json_only_short_strict" / "single_changes_quick_summary.csv"
