...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v20_strict.json'
COMB_ENV = os.environ.get('V20_COMB', 'experiments/combinations_json_only_timeout18_time_reduce_v20_strict_mdd.json')
...
if __name__ == '__main__':
    ...
    d = ROOT / 'results_json_only_timeout18_time_reduce_v20_strict'
    d.mkdir(parents=True, exist_ok=True)
    pd.DataFrame(out).to_csv(d / 'single_changes_quick_summary_mdd.csv', index=False)
