...
SRC = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v32_non_top200_mdd_focus.json'
DST = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v27_strict_score_replace_topn.json'
V32_COMB_DEFAULT = 'experiments/combinations_json_only_timeout18_time_reduce_v32_non_top200_mdd_focus.json'
...
if __name__ == '__main__':
    ...
    try:
        ...
        os.environ['V27_COMB'] = os.environ.get('V32_COMB', V32_COMB_DEFAULT)
