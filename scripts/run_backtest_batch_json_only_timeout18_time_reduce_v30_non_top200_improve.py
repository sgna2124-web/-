...
SRC = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v30_non_top200_improve.json'
DST = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v27_strict_score_replace_topn.json'
V30_COMB_DEFAULT = 'experiments/combinations_json_only_timeout18_time_reduce_v30_non_top200_improve.json'
...
if __name__ == '__main__':
    ...
    try:
        ...
        os.environ['V27_COMB'] = os.environ.get('V30_COMB', V30_COMB_DEFAULT)
