...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v70_short_only_behavioral_elite_challengers.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v70_short_only_behavioral_elite_challengers.json'
...
if __name__ == '__main__':
    ...
    for exp in v56mod.v27mod.build_experiments(base, group):
        ...
        s.update({
            ...
            'engine_mode': 'behavioral_elite_challengers_short',
        })
