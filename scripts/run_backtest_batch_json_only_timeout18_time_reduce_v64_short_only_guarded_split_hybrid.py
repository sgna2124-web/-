...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v64_short_only_guarded_split_hybrid.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v64_short_only_guarded_split_hybrid.json'
...
if __name__ == '__main__':
    ...
    for exp in vsplitmod.build_experiments(base, group):
        ...
        s.update({
            ...
            'engine_mode': 'guarded_split_hybrid_short',
        })
