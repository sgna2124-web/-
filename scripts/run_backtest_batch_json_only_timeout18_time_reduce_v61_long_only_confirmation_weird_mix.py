...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v61_long_only_confirmation_weird_mix.json'
COMB = ROOT / 'experiments' / 'combinations_json_only_timeout18_time_reduce_v61_long_only_confirmation_weird_mix.json'
