...
SRC = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v34_adv_baseline_exploration.json'
DST = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v27_strict_score_replace_topn.json'
V34_COMB_DEFAULT = 'experiments/combinations_json_only_timeout18_time_reduce_v34_adv_baseline_exploration.json'
...
if __name__ == '__main__':
    ...
    try:
        ...
        os.environ['V27_COMB'] = os.environ.get('V34_COMB', V34_COMB_DEFAULT)
