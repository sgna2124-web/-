...
BASE = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v22_strict_revalidate.json'
COMB_ENV = os.environ.get('V22_COMB', 'experiments/combinations_json_only_timeout18_time_reduce_v22_strict_revalidate.json')
...
if __name__=='__main__':
    ...
    d=ROOT/'results_json_only_timeout18_time_reduce_v22_strict_revalidate'; d.mkdir(parents=True, exist_ok=True); pd.DataFrame(out).to_csv(d/'revalidation_summary.csv', index=False)
