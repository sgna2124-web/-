...
SRC = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v40_rr60_t200_adventurous.json'
DST = ROOT / 'experiments' / 'base_config_json_only_timeout18_time_reduce_v27_strict_score_replace_topn.json'
V40_COMB_DEFAULT = 'experiments/combinations_json_only_timeout18_time_reduce_v40_rr60_t200_adventurous.json'
...
if __name__ == '__main__':
    ...
    try:
        ...
        os.environ['V27_COMB'] = os.environ.get('V40_COMB', V40_COMB_DEFAULT)
