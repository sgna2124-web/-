...
OLD=dict(strategy='smv8_mix2_13_all_timereduce5',trades=63105,max_return_pct=2743.3304850694603,max_drawdown_pct=5.686879318598392,official_cd_value=2681.6337117546423,profit_factor=1.5925867541542813)
...
def main():
    ...
    dd=data_dir(a.data_dir); out=Path(a.out_dir).expanduser().resolve() if a.out_dir else Path(__file__).resolve().parent/'short_max_v10_frozen_reproduce_results'; out.mkdir(parents=True,exist_ok=True)
