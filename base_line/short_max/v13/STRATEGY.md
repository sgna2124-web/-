...
이전 기준선
base_line/short_max/v12
smv11_topcombo1_03_combo03_stop215_rr540_tr4_top1_plus_rr540

갱신 사유
short_max v12 상위 조합 2차 탐색 결과 1위 후보를 단독 리테스트했고 gate를 통과했다.
기준선 v12 대비 official_cd_value, max_return_pct, max_drawdown_pct, profit_factor가 모두 개선되었다.
MDD가 3.2701695697124222%로 short_main 기준인 5% 미만도 통과한다.
...
이전 short_max v12 대비
v12 official_cd_value: 4136.12683229544
v13 official_cd_value: 6736.755883567657
delta_cd_vs_v12: +2600.629051272217
v12 max_drawdown_pct: 4.260534220480682
v13 max_drawdown_pct: 3.2701695697124222
delta_mdd_vs_v12: -0.9903646507682602
v12 trades: 63863
v13 trades: 66572
delta_trades_vs_v12: +2709
v12 profit_factor: 1.7783712609125915
v13 profit_factor: 2.190937542731158
delta_pf_vs_v12: +0.4125662818185667

핵심 전략 해석
진입 조건은 short_max v12 그대로 유지한다.
성과 개선의 핵심은 청산/방어 구조다.
time_reduce_bars를 3으로 유지하고, time_reduce_to_risk_frac를 0.00으로 낮췄다.
진입 후 3봉 이상 지나고 MFE가 양수이면 stop을 entry + risk * 0.00까지 당긴다.
숏 포지션 기준으로 유리한 움직임이 한 번이라도 나오면 손실 허용폭을 거의 본전선까지 줄이는 구조다.
timeout_bars는 240으로 늘려 좋은 진입이 목표가까지 도달할 시간을 더 준다.
DD brake는 0.035 / freeze 4로 기존 v12보다 약간 느슨하게 하여 수익 기회를 덜 막는다.
fail_fast_bars는 12로 설정한다.
...
탐색 결과에서는 MDD/CD가 극소 차이로 달랐지만, 기준선 공식값은 단독 리테스트 값이다.
