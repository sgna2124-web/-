...
1. 이전 v2를 다음 개선 기준으로 삼지 않는다.
2. v3의 atr_stop은 1.10이다. 1.01을 쓰면 v2 재현이 된다.
...
`long_max 현재 기준선은 v3 8V4_V09_V054_extreme_vol18__CH_tp03_risk_rr_plus20__DEV13_risk_stop_110이다. MDD 제한 없이 cd_value 336.7657621418 초과를 목표로 개선한다. 기준선 entry_key는 child::orig_V09_extreme_vol18::tp03이며, 청산 파라미터는 atr_stop 1.10, rr_target 2.90, max_hold 21, cooldown 31이다.`
