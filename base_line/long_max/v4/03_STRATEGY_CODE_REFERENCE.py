# -*- coding: utf-8 -*-
"""
long_max v4 기준선 코드 레퍼런스

공식 기준선 전략:
    8V4_V09_V054_extreme_vol18__CH_tp03_risk_rr_plus20__DEV13_risk_stop_110__DEV14_risk_rr_320

이 파일은 기준선 스펙, 공식 결과값, cd_value 계산식,
TP03 계산식, 재현 판정 기준을 코드로 바로 확인하기 위한 기준선 레퍼런스다.
"""
...
STRATEGY_SPEC = StrategySpec(
    name="8V4_V09_V054_extreme_vol18__CH_tp03_risk_rr_plus20__DEV13_risk_stop_110__DEV14_risk_rr_320",
    side="long",
