# long_max v2 기준선 재현 시작 문서

이 폴더의 목적은 다음 대화창의 새로운 작업자가 이전 대화 흐름을 몰라도 long_max v2 기준선을 같은 값으로 재현하고, 그 기준선에서 개선을 시작하게 만드는 것이다.
...
`MDD 제한 없이 official_cd_value가 가장 큰 전략.`
...
long_max 다음 개선은 이 기준선에서 시작한다.

- 목표: `official_cd_value > 311.3750675807`
...
`long_max 현재 기준선은 v2 8V4_V09_V054_extreme_vol18__CH_tp03_risk_rr_plus20이다. 기준선 재현값은 trades 57243, wins 20312, losses 36931, MDD 1.2219870757, cd_value 311.3750675807이다. V09/extreme/vol18/TP03를 이름만 보고 재해석하지 말고, frozen runner와 동일한 feature 계산·entry mask·청산 루프로 먼저 기준선을 재현한 뒤 개선한다.`
