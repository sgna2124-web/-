...
v9는 v8의 `body_atr >= 0.25` 필터 계승형이 아니다. V24에서 발견된 `long_max v7` entry 기반 조합을 V25에서 새 기준선 v8/v12와 단독 비교해 승격한 전략이다.

v8 대비:

- v8 final_entry: `long_max_v7_frozen_entry AND body_atr >= 0.25`
- v9 final_entry: `child::orig_V09_extreme_vol18::tp03`
- v8 청산: `atr_stop 1.15`, `rr_target 5.20`, `max_hold 21`, `cooldown 31`
- v9 청산: `atr_stop 1.12`, `rr_target 4.70`, `max_hold 18`, `cooldown 31`
