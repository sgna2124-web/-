...
1. errors == 0
2. ruined == false
3. 2025년까지의 데이터 기준 official_cd_value > 499.6598061090216
...
1. 이전 v8의 `body_atr >= 0.25` 필터를 자동 계승하지 않는다.
2. 다음 long_max 개선 기준은 v9의 cd_value `499.6598061090216`이다.
3. v8 기준값 `491.134662921777`을 다음 개선 기준으로 쓰지 않는다.
...
`long_max 현재 기준선은 v9 8V4_V09_V054_extreme_vol18__CH_tp03_risk_rr_plus20__DEV13_risk_stop_110__DEV14_risk_rr_320__DEV16_risk_rr_350__DEV19_risk_rr_380__LM15_rr420__DEV24_near_stop112_rr470_hold18이다. 2025년까지의 데이터 기준 cd_value 499.6598061090216 초과를 목표로 개선한다. 기준선 entry_key는 child::orig_V09_extreme_vol18::tp03이며, 청산 파라미터는 atr_stop 1.12, rr_target 4.70, max_hold 18, cooldown 31이다.`
