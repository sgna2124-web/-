...
1. 이전 v4를 다음 개선 기준으로 삼지 않는다.
2. v5의 rr_target은 3.50이다. 3.20을 쓰면 v4 계열 재현이 된다.
...
`long_max 현재 기준선은 v5 8V4_V09_V054_extreme_vol18__CH_tp03_risk_rr_plus20__DEV13_risk_stop_110__DEV14_risk_rr_320__DEV16_risk_rr_350이다. MDD 제한 없이 cd_value 400.8314684802 초과를 목표로 개선한다. 기준선 entry_key는 child::orig_V09_extreme_vol18::tp03이며, 청산 파라미터는 atr_stop 1.10, rr_target 3.50, max_hold 21, cooldown 31이다.`
