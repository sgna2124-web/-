...
- v7 max_return_pct: `241.3427142366`
...
long_main의 다음 목표는 `MDD < 5`를 유지하면서 `official_cd_value > 363.5507495661`을 달성하는 것이다.
...
- rr_target 3.10 / 3.25 / 3.30 주변 재탐색
...
- baseline_entry AND 손실 빈도 감소 필터
