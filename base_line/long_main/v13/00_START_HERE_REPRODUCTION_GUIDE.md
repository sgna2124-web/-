...
- long_main MDD 기준: `1.228290350505734 < 5`

## 핵심 주의사항

이 v13 전략은 v12의 `body_atr >= 0.25` 필터를 계승한 전략이 아니다. V24에서 발견된 기존 `long_max v7` 계열 entry 기반 조합이며, V25에서 새 v8/v12 기준선을 먼저 재현한 뒤 동일 조건에서 비교해 더 우수함을 확인했다.
...
long_main 다음 개선 목표는 2025년까지의 데이터 기준 `max_drawdown_pct < 5` 유지와 `official_cd_value > 499.6598061090216` 달성이다.
