...
long_main 기준선을 v6 `8V4_V09_V054_extreme_vol18__CH_tp03_risk_rr_plus20`에서 v7 `8V4_V09_V054_extreme_vol18__CH_tp03_risk_rr_plus20__DEV13_risk_stop_110`으로 갱신한다.

갱신 이유:

- long_main 기준인 `MDD 5% 미만 전략 중 cd_value 최대` 조건을 충족한다.
- v7의 MDD는 `1.3408670828%`로 5% 미만이다.
- v7의 cd_value는 `336.7657621418`로 v6의 `311.3750675807`보다 높다.
