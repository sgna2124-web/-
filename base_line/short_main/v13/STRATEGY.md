# short_main v13 전략 문서

## 공식 기준선

- strategy: smv11_topcombo1_03_combo03_stop215_rr540_tr4_top1_plus_rr540
- axis: short_main
- baseline_version: short_main/v13
- 이전 기준선: short_main/v12, smv10_dev1_01_v10_stop210_rr550
- 승격 사유: short_main식 기준인 MDD 5% 미만에서 기존 v12보다 official_cd_value가 높고, MDD도 낮다.
...
short_main v13은 short_max v12와 같은 전략 조건을 사용한다. 축(axis)만 short_main으로 기록한다. 이 전략은 MDD 4.260534220480682로 short_main식 MDD 5% 미만 조건을 만족하면서 기존 short_main v12의 official_cd_value를 초과했기 때문이다.

## v12 대비 핵심 변경

- atr_stop_mult: 2.10 -> 2.15
- rr_mult: 5.5 -> 5.4
- time_reduce_bars: 4 유지
- 진입 조건은 기존 short_main v12와 동일
...
- previous_strategy: smv10_dev1_01_v10_stop210_rr550
- previous_trades: 64128
- previous_max_return_pct: 3942.1044355472736
- previous_max_drawdown_pct: 4.38893845928694
- previous_official_cd_value: 3864.6989594109964
- previous_profit_factor: 1.7555392280496656
- delta_cd_vs_previous: +271.4278728844438
- delta_mdd_vs_previous: -0.12840423880625718
- delta_trades_vs_previous: -265

## 장점

- short_main식 MDD 5% 미만을 만족한다.
- 기존 short_main v12보다 official_cd_value가 상승했다.
- 기존 short_main v12보다 MDD가 낮아졌다.
- 거래 수는 줄었지만 profit_factor가 개선되었다.

## 단점과 리스크

- win_rate는 11.0001%로 낮다. 다수 손실과 소수 target 수익에 의존한다.
- max_conc 310으로 동시 포지션 수가 많다.
- stop 폭 2.15는 v12보다 넓으므로 급등 손실 포지션의 체류 시간이 길어질 수 있다.
