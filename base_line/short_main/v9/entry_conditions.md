...
그 외 score 구조, RSI gate 미사용, stop/target, fail fast, DD brake, 수수료, 자산 분할, actual bar engine은 v8과 동일하다.
...
`close[t] / EMA20[t] - 1 >= 0.03475`

2. 윗꼬리 조건

`upper_wick[t] >= 1.20 * body[t]`
...
dev_score = min(dev_raw / 0.03475, 2.0)
