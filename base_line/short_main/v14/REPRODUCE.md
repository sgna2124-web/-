short_main v14 재현 가이드

목적
처음 보는 사람이 short_main v14 기준선을 같은 데이터셋에서 주관적 해석 없이 재현하도록 실행 조건과 gate 값을 고정한다.

공식 기준선
strategy: smv12_topmix2_07_mix2_07_top1_reduce_frac000
axis: short_main
baseline_version: short_main/v14
이전 기준선: short_main/v13
...
공식 실행 명령
python base_line/short_main/v14/frozen_reproduce_runner.py --data-dir "C:\Users\user\Desktop\LCD\파이썬\코인\Data\time"

현재 v14의 frozen_reproduce_runner.py는 공식 리테스트 러너 run_short_max_v12_topmix2_07_retest_v2.py의 조건과 gate 값을 기준으로 한다.
...
short_main 승격 기준
MDD 5% 미만 조건을 통과해야 한다.
공식 리테스트 MDD는 3.2701695697124222%이므로 통과한다.
기존 short_main v13보다 official_cd_value, MDD, PF가 모두 개선되었다.
