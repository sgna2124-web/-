...
def main():
    ...
    dd=resolve_data_dir(a.data_dir); out=Path(a.out_dir).expanduser().resolve() if a.out_dir else Path(__file__).resolve().parent/'short_main_v12_frozen_reproduce_results'; out.mkdir(parents=True,exist_ok=True)
