...
- 즉 신규 reversal family 자체는 살아 있었지만, 현재 형태로는 고수익-고MDD와 저위험-저수익 사이의 간극을 메우지 못했다.
7V2_LONG40_REVIEWED에서도 기준선 교체가 없었다.
...
- 그다음 MDD<5: 7V2_L07_V08_wick_closedrive | final_return_pct 15.3392 | max_return_pct 15.7100 | max_drawdown_pct 3.3512 | cd_value 111.4740 | trades 1439
- 7V1 대비 진전은 분명하다. 신규 reversal family가 제한형으로도 cd 110대까지 올라왔다.
- 하지만 아직 공식 long 기준선 121.5300을 넘는 MDD<5 전략은 나오지 않았다.
- 현재 우선순위는 L09 beartrap family와 L07 wick family를 중심으로, same-bar raw edge는 유지하되 shockfresh age, recent-fire suppression, refractory spacing을 더 강하게 결합해 승격 후보를 만드는 것이다.
