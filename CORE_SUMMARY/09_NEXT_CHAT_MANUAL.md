...
12. 다음 전략을 제안하기 전에 방금 갱신한 CORE_SUMMARY/12_STRATEGY_STRENGTHS_WEAKNESSES.md 를 다시 읽고, 그 항목을 실제 생성 규칙으로 반영한다.
...
최근 상태 인식
4V2R14 ~ 4V2R16은 저장소에 반영되었다.
이 구간은 롱 전용 전략이 여전히 공식 1위를 위협하지 못하고 있음을 보여준다.
숏 측에서는 일부 강한 폭발형 후보가 있었지만 MDD 조건을 넘기는 경우가 많아 공식 승격에는 실패했다.
따라서 다음 우선순위는 롱 전용 구조 개선이며, 숏은 상위권 유지/보조 개선 중심으로 본다.
